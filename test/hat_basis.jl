...
for l in 1:7
    ...
    @test hquadrature(diff_standard, 0, 1; abstol=1.0e-9)[1] ≈ 
          hquadrature(diff_hier, 0, 1; abstol=1.0e-9)[1] atol=1.0e-14
    @test hquadrature(diff_both, 0, 1; abstol=1.0e-9)[1] ≈ 0 atol=1.0e-14
end
